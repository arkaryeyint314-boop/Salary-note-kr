...
- Factory Pay Rules are edited only in Profile. Calculator shows the resulting Verified by contract, User Manual, and total Factory Pay Rules amounts without duplicate rule-edit controls.
